...
[Home](../README.md) · [120 prompt recipes](../prompts/README.md) · [Flyne AI workflow](flyne-ai-guide.md) · [15-language directory](../prompts/i18n/README.md)
...
Start with the [120-prompt finder](../prompts/README.md), then adapt the closest recipe instead of writing from a blank page.
