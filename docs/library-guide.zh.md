...
- [在 Flyne AI 使用 Seedance 2.5](flyne-ai-guide.md)
...
这段首页改写已对应现有配图：狐狸从开头就保持立体纸艺，先转头抬爪，再走下纸页。也可以直接使用[与此图对应的八秒练习](reference-practice.md#fox)。
...
| [使用场景选择矩阵](use-case-matrix.md) | 18 类目标 | 按业务、素材、渠道与画幅快速选择模板 |
...
- 本项目基于 FLAQ 开源仓库改编，保留上游版权；Flyne AI 品牌封面和新增案例说明单独维护。详见 [来源与版权](PROVENANCE.md)。
- 参考图与品牌插画的生成说明见 [Original Image Prompt Notes](../assets/IMAGE_PROMPTS.md)。
