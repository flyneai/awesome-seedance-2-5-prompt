...
![Seedance 2.5 提示词指南原创封面](assets/flyne-seedance-hero.png)

这是一个面向 **Seedance 2.5 文生视频、图生视频、多参考控制、视频编辑与延长** 的原创提示词库，现已收录 **120 个完整实用场景、15 种语言支持和 14 份独立外语 prompts 文件**。其中包含 60 个中文通用场景与 60 个英文专业及创作工作流，覆盖电影叙事、节拍剪辑、一镜到底、品牌广告、电商、UGC、社媒喜剧、动态海报、原创动画、材质变形、教程、数字人、批量 SKU、长视频、教育、无障碍、局部编辑、绿幕与白模预演。

| [浏览 120 个 Prompts](prompts/README.md) | [提交你的 Prompt](https://github.com/flyneai/awesome-seedance-2-5-prompt/issues/new?template=prompt.yml) | [贡献指南](CONTRIBUTING.md) | [Prompt 写作教程](docs/prompting-guide.md) | [在 Flyne AI 生成](https://flyne.ai/model/seedance-2-5/) |
|---|---|---|---|---|

## X 社区视频案例：看成片、读原帖、改提示词

现收录 **18 个 X 视频案例**，本次新增 6 个。每个案例都有作者、原帖、视频预览、视频链接及可复制的改写提示词。原视频的完整提示词请看作者原帖；本仓库改写版未经生成测试，不能视为原视频的生成参数。

[查看全部 18 个视频及提示词](README.md#seedance-25-videos-from-x--watch-inspect-remix) · [来源记录](docs/x-showcase-sources.md)

| 新增案例 | 视频与提示词 | 作者原帖 |
|---|---|---|
| 五人舞蹈与队形变化 | [查看视频及改写提示词](README.md#x13-dance-formation) | [@Goodmanprotocol](https://x.com/Goodmanprotocol/status/2100281777197834731) |
| 狐狸与雪鸮的雪地冒险 | [查看视频及改写提示词](README.md#x14-fox-sled) | [@Strength04_X](https://x.com/Strength04_X/status/2100254817818169630) |
| 从备料到装盘的天妇罗 | [查看视频及改写提示词](README.md#x15-tempura-process) | [@Goodmanprotocol](https://x.com/Goodmanprotocol/status/2099814823219392548) |
| 双人夜间公路旅行 | [查看视频及改写提示词](README.md#x16-night-road-trip) | [@noorwithwifi](https://x.com/noorwithwifi/status/2099114117017780321) |
| 开往太空的列车 | [查看视频及改写提示词](README.md#x17-lunar-train) | [@Strength04_X](https://x.com/Strength04_X/status/2098290630179057858) |
| 小狗闯入镜子自拍 | [查看视频及改写提示词](README.md#x18-dog-mirror) | [@Strength04_X](https://x.com/Strength04_X/status/2097616213371478242) |

新增原帖正文及全部媒体链接检查日期为 2026-09-21。模型名称来自发布者自述，未独立验证。部分原帖要求竖屏，但实际上传视频为横屏，条目中已注明。

## 欢迎提交原创 Prompt

如果你有经过真实生成验证、对其他创作者或开发者有复用价值的 Seedance 2.5 Prompt，可以通过[结构化提交表单](https://github.com/flyneai/awesome-seedance-2-5-prompt/issues/new?template=prompt.yml)分享。请提供完整 Prompt、模型与参数、素材职责、实际生成结果、迭代记录以及希望展示的作者名称；通过审核的内容可在整理后署名收录。
...
## 在 Flyne AI 使用 Seedance 2.5

把提示词或参考图做成产品展示、人物短片、社交视频和剧情片段。

1. 选择提示词，替换主体、场景和动作。
2. 需要保持产品或人物外观时，上传自己的产品图或已获授权的人像。
3. 选择页面支持的时长、比例、分辨率和声音选项，确认费用后生成。
4. 检查外观、动作、声音和结尾，每次只改一个问题。

[前往 Flyne AI →](https://flyne.ai/model/seedance-2-5/) · [操作指南 →](docs/flyne-ai-guide.md)

开发者也可使用推荐的 [FLAQ Seedance 2.5 文生视频接口](https://flaq.ai/models/bytedance/seedance-2-5-text-to-video/)，并参考 [FLAQ 接入指南](docs/flaq-ai-api-guide.md)。两个平台的账户、计费和参数分别以各自页面为准；本项目未测试服务稳定性。

## 目录

- [Seedance 2.5 适合做什么](#seedance-25-适合做什么)
- [在 Flyne AI 使用 Seedance 2.5](#在-flyne-ai-使用-seedance-25)
...
以下示例均为本仓库重新构思的原创场景，不包含影视 IP、名人形象或第三方品牌。
...
- [Seedance 2.5 Image-to-Video 在线页面](https://flyne.ai/model/seedance-2-5/)
- [Seedance 2.5 Text-to-Video 在线页面](https://flyne.ai/model/seedance-2-5/)
- [Seedance 2.0 官方发布说明](https://seed.bytedance.com/en/blog/seedance-2-0-official-launch)

## 内容与版权说明

- 本项目基于 FLAQ 开源仓库改编，保留上游版权；Flyne AI 品牌封面和新增案例说明单独维护。详见 [来源与版权](docs/PROVENANCE.md)。
- 四张配图的可复现生成说明见 [Original Image Prompt Notes](assets/IMAGE_PROMPTS.md)。
