...
[Prompt TXT / 提示词正文](006.zh.txt) · [Recipe / 场景原页](../prompt-library.md#06-模块化运动手环功能演示) · [Online source / 在线来源](https://github.com/flyneai/awesome-seedance-2-5-prompt/blob/main/prompts/prompt-library.md#06-模块化运动手环功能演示)
