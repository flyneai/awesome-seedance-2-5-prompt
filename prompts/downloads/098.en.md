# 098 · Replace Only a Blank Package Color Region

[Prompt TXT / 提示词正文](098.en.txt) · [Recipe / 场景原页](../creative-techniques.en.md#98-replace-only-a-blank-package-color-region) · [Online source / 在线来源](https://github.com/flyneai/awesome-seedance-2-5-prompt/blob/main/prompts/creative-techniques.en.md#98-replace-only-a-blank-package-color-region)
