...
[Prompt TXT / 提示词正文](044.zh.txt) · [Recipe / 场景原页](../extended-scenarios.md#44-安全使用台钻的四步演示) · [Online source / 在线来源](https://github.com/flyneai/awesome-seedance-2-5-prompt/blob/main/prompts/extended-scenarios.md#44-安全使用台钻的四步演示)
